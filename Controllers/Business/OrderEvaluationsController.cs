...
{
    ///<summary>Quản lý đánh giá Đơn Hàng đã tiếp nhận - dành cho Người Bán.</summary>
    ...
    public class OrderEvaluationsController : ControllerBase
    {
        ...
        /// <summary>
        /// Người Bán đánh giá Người Mua thông qua Đơn Hàng.
        /// </summary>
        ...
        /// <response code="423">Đơn Hàng hoàn tất mới được đánh giá.</response>
        [HttpPost]
        ...
        public IActionResult Post([Required] OrderEvaluation orderEvaluation)
        {
            ...
            if (db.OrderEvaluations.Any(p => p.OrderId.Equals(orderEvaluation.OrderId) && p.Type.Equals(true)))
                return new StatusError
                {
                    StatusCode = StatusCodes.Status403Forbidden,
